                    ...
                    <div className="flex flex-wrap -m-4">
                        <div className="p-4 mmd:w-1/2 llg:w-full">
                            <div className="flex border-2 rounded-lg border-gray-200 border-opacity-50 p-8  flex-col">
                                <p className=' bg-green-600 text-white pl-2 rounded text-xl mb-3 p-1'>KEY HIGHLIGHTS</p>
                        ...
                        <div className="p-4 mmd:w-1/2 llg:w-full">
                            <div className="flex border-2 rounded-lg border-gray-200 border-opacity-50 p-8  flex-col">
                            <p className=' bg-green-600 text-white text-xl p-1 pl-2 rounded mb-3'>KEY TAKEAWAYS</p>
                                <div className="flex-grow">
