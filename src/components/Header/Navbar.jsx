    ...
    return (
        <div className=' bg-nav-img bg-cover text-white pb-10'>
            <div className='flex flex-row justify-between px-40 sm:px-5 md:px-20 p-4 pb-10 bg-black bg-opacity-60'>
                <div className=' text-2xl font-extrabold font-mono text-green-500'>LSO 2024</div>
                <Dropdown4 />
            ...
            <div className='flex justify-center'>
                <div className={visib}>
                    <div className='flex flex-col rounded-3xl p-10'>
                        <div className='flex justify-center font-bold md:text-sm'>4th Summer School</div>
                        <div className='flex justify-center font-bold text-2xl md:text-lg'>Large Scale Optimization(LSO)</div>
                        ...
                        <div className='flex justify-center font-bold md:text-sm'>18 - 26th May 2024</div>
