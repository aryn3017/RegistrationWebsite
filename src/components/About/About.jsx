...
function About({Heading,Content}) {
  return (
    ...
    <div className=' flex flex-col items-start px-10 sm:px-5 mt-10 mb-10'>
        ...
        <a href="https://ideea-model.github.io/IDEEA/index.html" className=' bg-green-500 p-3 rounded-lg text-white font-bold border-2 hover:bg-green-600'>Click here to know more</a>
    </div></>
  )
}
